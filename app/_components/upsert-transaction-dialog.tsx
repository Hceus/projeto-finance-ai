...
import { upsertTransction } from "../_actions/upsert-transaction";
...
const formSchema = z.object({
  ...
  amount: z
    .number({
      required_error: "O valor deve ser positivo.",
    })
    .positive({
  ...
  date: z.date({
    required_error: "O data é obrigatória.",
  }),
});
...
const UpsertTransactionDialog = ({
  ...
  const onSubmit = async (data: FormSchema) => {
    try {
      await upsertTransction({ ...data, id: transactionId });
      setIsOpen(false);
      form.reset();
    } catch (error) {
      console.log(error);
